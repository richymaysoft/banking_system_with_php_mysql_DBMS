						...
						<div id="content">
							<div id="invoice-POS" class="myBg" style="padding: 5px 5px;">
								...
								<div id="mid">
									<div class="info">
										<p>
											International transactions will take 2-3 days to be processed and sent.
										</p>
									</div>
								</div>
								<!--End Invoice Mid-->
								...
								<div id="bot">
									<?php $final = $conn->query( "SELECT * FROM transfer WHERE ref='$Ref'" );
												$receipt = $final->fetch_assoc();
												$accVerify = $receipt['sender_acc'];
												if ($accVerify == $check_acc){
												$xType = 'CHECKING';
												} else if ($accVerify == $savings_acc){
												$xType = 'SAVINGS';
												}
													?>
									<div id="table">
