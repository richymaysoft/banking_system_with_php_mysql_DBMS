						...
						<div class="col-lg-12">
							...
							<div class="card">
								<div class="card-header">
									<span><i class="fa fa-caret-down text-primary"></i> <span class="font-weight-bold"><?= $page; ?></span></span>
									<a href="index.php" class="float-right btn btn-sm btn-outline-primary">Dashboard</a>
								</div>
								<div class="card">
									<div class="card-header">
										...
										<div class="card-body">
											...
											<div class="form-row">
												<div class="col-md-3 mb-3">
													<label class="text-primary font-weight-bold">Account ID</label> <input type="text" class="form-control" name="acc_id" value="<?= rand(1000000,9999999); ?>" required>
												</div>
											...
											<div class="form-row">
												<!-- form column -->
												<div class="col-md-3 mb-3">
													<label class="text-danger font-weight-bold">Checking Account Number</label> <input type="number" class="form-control" name="check_acc" value="<?= $acc_no.$md.rand(100,999); ?>" required>
												</div>

												<div class="col-md-3 mb-3">
													<label class="text-danger font-weight-bold">Checking Account Balance</label> <input type="number" class="form-control" name="check_balance" value="0" required>
												</div>

												<div class="col-md-3 mb-3">
													<label class="text-success font-weight-bold">Savings Account Number</label> <input type="number" class="form-control" name="savings_acc" value="<?= $acc_no.$md.rand(100,999); ?>" required>
												</div>

												<div class="col-md-3 mb-3">
													<label class="text-success font-weight-bold">Savings Account Balance</label> <input type="number" class="form-control" name="savings_balance" value="0" required>
												</div>
											...
											<div class="form-row">
												...
												<div class="col-md-3 mb-3">
													<label class="text-primary font-weight-bold">COT Code</label> <input type="text" class="form-control" name="cot" value="<?= '1100'.rand(10000,99999); ?>" required>
												</div>

											</div>
											<div class="form-row">
												<div class="col-md-3 mb-3">
													<label class="text-primary font-weight-bold">TAX Code</label> <input type="text" class="form-control" name="tax" value="<?= rand(100,999).'-'.rand(100,999); ?>" required>
												</div>
												<div class="col-md-3 mb-3">
													<label class="text-primary font-weight-bold">IMF Code</label> <input type="text" class="form-control" name="imf" value="<?= $abrv.rand(10,99); ?>" required>
												</div>

												<div class="col-md-3 mb-3">
													<label class="text-primary font-weight-bold">Credit Card Last 4 Digit</label> <input type="text" class="form-control" name="creditCard" value="<?= rand(1000,9999); ?>" required>
												</div>

												<div class="col-md-3 mb-3">
													<label class="text-primary font-weight-bold">Card Expiry Month/Year</label> <input type="text" maxlength="5" class="form-control" name="cc_exp" value="<?= date("m").'/'.(date("y")+3); ?>" required>
												</div>
											...
											<div class="form-row">
												...
												<div class="col-md-3 mb-3">
													...
													<input id="flatpickr02" type="text" name="created_at" value="" class="form-control" data-toggle="flatpickr" data-enable-time="false" data-date-format="l J \of F Y" required>
												</div>
												...
												<div class="col-md-3 mb-3">
													...
													<input name="create_account" type="submit" class="btn btn-primary form-control" value="Create Account">
												</div>
